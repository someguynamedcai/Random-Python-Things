            ...
            if number == "exit" or number == "Exit":
                ...
                match location:
                    case 'S':
                        ...
                        Fullauctionlink = auctionlink + Sjson['auctions'][Sauctions]['id'] + "/item/" + SPost['items'][int(number)-1]['id']                                                                     
...
while Redirectto != "No":
    if (Redirectto == "Sacramento" or Redirectto == "sacramento" or Redirectto == 's' or Redirectto == 'S'):
        ...
        print ("The first auction gallery in Roseville is a " + (ROjson['auctions']['1']['title']))
